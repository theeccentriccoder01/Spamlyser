...
class TestPhishingDetection:
    ...
    def test_detects_account_verification_phishing(self):
        ...
        message = (
            "Verify your account immediately. Click here: https://fake.com"
        )
    ...
    def test_detects_password_update_phishing(self):
        ...
        message = (
            "Update your password for security. Confirm your credentials now."
        )
...
class TestScamFraudDetection:
    ...
    def test_detects_urgent_money_offer(self):
        ...
        message = (
            "URGENT: Million dollar opportunity available TODAY. Act now!"
        )
...
class TestUnwantedMarketingDetection:
    ...
    def test_detects_discount_offer(self):
        ...
        message = (
            "Limited time offer! Get 50% discount on all items. Shop now!"
        )
    ...
    def test_detects_subscription_offer(self):
        ...
        message = (
            "Join our membership and save! Subscribe now for exclusive deals."
        )
...
class TestThreatSpecificAdvice:
    ...
    def test_scam_fraud_advice_available(self):
        ...
        assert len(advice) > 0
        assert any(
            "too good to be true" in a.lower() or "prize" in a.lower()
            for a in advice
        )
    ...
    def test_marketing_advice_available(self):
        ...
        assert len(advice) > 0
        assert any(
            "stop" in a.lower() or "opt out" in a.lower() for a in advice
        )
...
class TestEdgeCases:
    ...
    def test_case_insensitivity(self):
        ...
        assert all(
            isinstance(c, float) for c in [conf_lower, conf_upper, conf_mixed]
        )
...
class TestComplexScenarios:
    ...
    def test_message_with_url_patterns(self):
        ...
        message = (
            "Verify at https://bank-secure.com/verify or http://fake-bank.ru"
        )
        threat_type, confidence, metadata = classify_threat_type(message, 0.85)
