...
def render_anomaly_dashboard() -> None:
    ...
    st.markdown(
        "Identifies unusual messages, model disagreements, and confidence outliers."
    )
    ...
    with tab2:
        ...
        for i, (_, row) in enumerate(top_df.iterrows()):
            ...
            st.markdown(
                f"""<div class="anomaly-card {anomaly_type}">
    ...
    with tab3:
        ...
        with col2:
            ...
            fig2.add_vline(
                x=np.percentile(df["composite_anomaly"], 90),
                line_dash="dash",
                line_color="#ff4444",
            )
            fig2.update_layout(
