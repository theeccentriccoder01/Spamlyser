...
st.markdown(
    "Test your custom threat intelligence regex rules against sample datasets before deploying to production."
)
...
with col1:
    st.text_input(
        "Regex Pattern", value=r"(?i)(urgent|immediate action required)"
    )
with col2:
